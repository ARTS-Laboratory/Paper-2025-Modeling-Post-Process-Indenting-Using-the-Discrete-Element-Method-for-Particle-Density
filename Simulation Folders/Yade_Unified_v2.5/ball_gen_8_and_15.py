        ...
        if indent:
                if ballLoc == 'right':
                        ...
                        wallSphere = yade.utils.sphere(
                                ...
                                sphereRad, material='x_walls', wire=True)
                        # wallSphere = yade.utils.sphere(
...
def ballvel():
        backBallVelCond = (indentDepth - sphereRad)
        if indent:
                global ballclump
                if ballLoc == "right":
                        if O.bodies[wallSphereId].state.pos[0] > (box_x + thick/2):
                        #if O.iter < 20000:
                                O.bodies[wallSphereId].state.vel = (-1/(thick/2), 0, 0)
                ...
                if ballLoc == 'back':
                        ...
                        if O.bodies[wallSphereId].state.pos[2] < backBallVelCond:
                                O.bodies[wallSphereId].state.vel = (0, 0, 1000)
                                print('ballvel Active')
